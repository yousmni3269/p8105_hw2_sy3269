...
```
    ...
    ##   dumpster month  year date                weight_tons volume_cubic_yards
    ##      <dbl> <chr> <int> <dttm>                    <dbl>              <dbl>
    ## 1      584 June   2023 2023-06-29 00:00:00        3.9                  15
    ## 2      571 March  2023 2023-03-06 00:00:00        3.14                 15
    ## 3      572 March  2023 2023-03-29 00:00:00        3.41                 15
    ## 4      579 May    2023 2023-05-04 00:00:00        3.66                 15
    ## 5      580 May    2023 2023-05-04 00:00:00        2.62                 15
    ## 6       NA <NA>     NA NA                      1875.                 8934
    ## # ℹ 9 more variables: plastic_bottles <dbl>, polystyrene <dbl>,
    ## #   cigarette_butts <dbl>, glass_bottles <dbl>, plastic_bags <dbl>,
    ## #   wrappers <dbl>, sports_balls <int>, homes_powered <dbl>,
    ## #   trash_wheel_type <chr>
...
Any unnecessary data, such as non-dumpster specific data or figure, was
removed and required columns were specified for the import. Also,
`trash_wheel_type` variable was added to the data frame so that I can
keep track of which trash wheel data is which when I bind this data
frame with other trash wheel data. Head and tail of the cleaned data was
checked.
...
```
    ...
    ##   dumpster month     year date                weight_tons volume_cubic_yards
    ##      <dbl> <chr>    <dbl> <dttm>                    <dbl>              <dbl>
    ## 1      103 April     2023 2023-04-10 00:00:00        2.05                 15
    ## 2      104 April     2023 2023-04-20 00:00:00        2.58                 15
    ## 3      102 February  2023 2023-02-15 00:00:00        2.41                 15
    ## 4      105 June      2023 2023-06-16 00:00:00        1.85                 15
    ## 5      106 June      2023 2023-06-29 00:00:00        2.25                 15
    ## 6       NA <NA>        NA NA                       216.                 1546
    ## # ℹ 8 more variables: plastic_bottles <dbl>, polystyrene <dbl>,
    ## #   cigarette_butts <dbl>, glass_bottles <dbl>, plastic_bags <dbl>,
    ## #   wrappers <dbl>, homes_powered <dbl>, trash_wheel_type <chr>
...
```
    ...
    ##   dumpster month  year date                weight_tons volume_cubic_yards
    ##      <dbl> <chr> <dbl> <dttm>                    <dbl>              <dbl>
    ## 1      140 March  2023 2023-03-14 00:00:00        2.91                 15
    ## 2      145 May    2023 2023-05-01 00:00:00        2.85                 15
    ## 3      146 May    2023 2023-05-01 00:00:00        3.22                 15
    ## 4      147 May    2023 2023-05-04 00:00:00        3.44                 15
    ## 5       NA <NA>     NA NA                        NA                    NA
    ## 6       NA <NA>     NA NA                       452.                 2309
    ## # ℹ 7 more variables: plastic_bottles <dbl>, polystyrene <dbl>,
    ## #   cigarette_butts <dbl>, plastic_bags <dbl>, wrappers <dbl>,
    ## #   homes_powered <dbl>, trash_wheel_type <chr>
...
set, total 849 observations were found, where 107 observations came from
Professor Trash Wheel, 157 from Gwynnda Trash Wheel, and 585 from
Mr. Trash Wheel.
...
tons whereas Gwynnda Trash Wheel and Mr. Trash Wheel collected NA tons
and 3750.2 tons, respectively.
...
`baker` variable (e.g. Jo was input as “Jo”).
