...
Similarly, I imported and cleaned `bakes.csv` and `results.csv` files. For `bakes.csv`, I eliminated unnecessary `""` marks in a value under `baker` variable (e.g. Jo was input as "Jo").
